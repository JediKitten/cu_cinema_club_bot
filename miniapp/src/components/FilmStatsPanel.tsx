      ...
      {stats.dynamics.length > 0 && (
        <>
          ...
          <Bars
            ...
            // Те же цвета, что у самих кнопок отметки: 🟣 и 🟠.
            color="var(--wishlist)"
            hint="По неделям: фиолетовым — «Желаемое», оранжевым — «Ближайшее». Считается по моменту отметки, а не по её нынешнему состоянию."
          />
        </>
      )}
