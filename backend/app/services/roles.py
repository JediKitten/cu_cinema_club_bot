...
ABILITIES: dict[UserRole, str] = {
    UserRole.MODERATOR: (
        "Вам доступна вкладка «Клуб»: отметка присутствия и список пришедших, "
        "а также шорт-лист и расстановка показов, если этап не закрыли вовремя. "
        "Заявки на фильмы разбирают администраторы."
    ),
    UserRole.ADMIN: (
