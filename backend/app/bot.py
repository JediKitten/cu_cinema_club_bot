...
TOUR: tuple[tuple[str, str], ...] = (
    (
        ...
        "В приложении пять вкладок: 🎞 Каталог, ★ Мои, 📅 Расписание, "
        "👥 Друзья и ☰ Ещё. Дальше — про каждую.",
    ),
    (
        "Две кнопки на карточке",
    ...
    (
        ...
        "отметки. Порядок выбирается списком сверху, а рядом — переключатель "
        "вида: строками или плиткой постеров.\n\n"
        "Всё, что вы отметили, лежит во вкладке <b>«Мои»</b>: ближайшее, "
        "желаемое и просмотренное — тремя разделами.\n\n"
    ...
    (
        "👥 Друзья и ваш профиль",
        "Во вкладке <b>«Друзья»</b> — люди клуба и их лента: что отметили, "
        "что посмотрели, как оценили. Чужая оценка убеждает сходить сильнее "
        "любого рейтинга.\n\n"
        "Там же ваш профиль. <b>Обязательно поставьте в него четыре любимых "
        "фильма</b> — по ним вас найдут те, с кем совпадает вкус, и это первое, "
        "что видят, открыв ваш профиль. Занимает полминуты.",
    ),
    (
        "Позвать своих",
